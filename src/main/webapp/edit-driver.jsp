...
<%
    ...
    Driver driver = (Driver) request.getAttribute("driver"); // set by servlet on validation error
    if (driver == null) {
        String idParam = request.getParameter("id");
        if (idParam == null || idParam.isEmpty()) { response.sendRedirect("driver-list.jsp"); return; }
        driver = new DriverDAO().getDriverById(Integer.parseInt(idParam));
...
<head>
    ...
    <title>Edit Driver - Fleet Tracker</title>
...
<div class="bg-white border-bottom py-3 px-4 shadow-sm">
    <div class="container-fluid">
        ...
        <h5 class="fw-bold mt-1 mb-0">
            <i class="bi bi-pencil-square me-2 text-warning"></i>Edit Driver —
            <span class="text-muted"><%= driver.getName() %></span>
        </h5>
    </div>
</div>
        ...
        <div class="col-lg-9 col-xl-8">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white border-bottom py-3">
                    <h6 class="mb-0 fw-semibold text-secondary"><i class="bi bi-info-circle me-2"></i>Edit Driver Information</h6>
                </div>
                <div class="card-body p-4">
                    <form action="<%= request.getContextPath() %>/update-driver" method="post"
                          novalidate id="editDriverForm">
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                       value="<%= driver.getEmail() %>" required>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="phone" name="phone"
                                       value="<%= driver.getPhone() != null ? driver.getPhone() : "" %>">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="emergencyContact" name="emergencyContact"
                                       value="<%= driver.getEmergencyContact() != null ? driver.getEmergencyContact() : "" %>">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="licenseExpiry" name="licenseExpiry"
                                       value="<%= driver.getLicenseExpiry() != null ? driver.getLicenseExpiry().toString() : "" %>">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="status" name="status" required>
                                    <option value="Active"   <%= "Active".equals(driver.getStatus())   ? "selected" : "" %>>Active</option>
                                    <option value="Inactive" <%= "Inactive".equals(driver.getStatus()) ? "selected" : "" %>>Inactive</option>
                                    <option value="On Leave" <%= "On Leave".equals(driver.getStatus()) ? "selected" : "" %>>On Leave</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="address" name="address"
                                      rows="2"><%= driver.getAddress() != null ? driver.getAddress() : "" %></textarea>
                        </div>
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <a href="driver-details.jsp?id=<%= driver.getId() %>" class="btn btn-outline-info">
